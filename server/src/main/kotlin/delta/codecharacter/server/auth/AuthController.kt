...
@RestController class AuthController(
    ...
    override fun passwordLogin(@RequestBody passwordLoginRequestDto: PasswordLoginRequestDto): ResponseEntity<PasswordLoginResponseDto> {
        ...
        if (verifyPassword(password,isUser.password)) {
            ...
            return ResponseEntity.status(HttpStatus.ACCEPTED)
                .body(PasswordLoginResponseDto(jwt))
        } else
            throw CustomException(HttpStatus.NOT_FOUND, "Invalid Password")
    }
